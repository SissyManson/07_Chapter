...
namespace _06_Task
{
    class Program
    {
        ...
        {
            //Напишете програма, която намира максималната подредица от нараст­ващи елементи в масив arr[n].Елементите може и 
            //да не са последо­вателни. 
            //Пример: { 9, 6, 2, 7, 4, 7, 6, 5, 8, 4}
            //à { 2, 4, 6, 8}.
